...
[CustomEditor(typeof(EnemyBehavior_Patrol)), CanEditMultipleObjects]
public class EnemyBehavior_PatrolEditor : Editor
{

    int firstSelected = -1;
    protected virtual void OnSceneGUI() {
        EnemyBehavior_Patrol enemy = (EnemyBehavior_Patrol)target;
        Patrol(enemy);
    }

    void Patrol(EnemyBehavior_Patrol enemy) {
    ...
    void CreateFirstWaypoint(EnemyBehavior_Patrol enemy) {
    ...
    void AddWaypoint(EnemyBehavior_Patrol enemy) {
        Waypoint w = new Waypoint();
        w.areaRadius = 1f;
    ...
    void DeleteWaypoint(EnemyBehavior_Patrol enemy) {
    ...
    void AddWaypointToSelected(EnemyBehavior_Patrol enemy, int selectedWayPoint) {
        Waypoint w = new Waypoint();
        w.areaRadius = 1f;
    ...
    void SelectedWaypointUI(EnemyBehavior_Patrol enemy) {
        Handles.BeginGUI();
